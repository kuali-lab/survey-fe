...
<div class="card">
  ...
  <div class="body">
    <h1 class="title">Kamera belum aktif</h1>
    <p class="description">
    ...
    {#if showInstructions}
      <div class="instructions">
        <div class="instr-block">
          ...
          <p>Klik ikon gembok di kiri address bar → <em>Site settings</em> → <em>Camera</em> → <em>Allow</em>, lalu muat ulang halaman.</p>
        </div>
        <div class="instr-block">
          <strong>Safari (Mac)</strong>
          <p>Menu Safari → <em>Settings for This Website…</em> → <em>Camera</em> → <em>Allow</em>.</p>
        </div>
        <div class="instr-block">
          <strong>Chrome / Safari (iPhone)</strong>
          <p>Buka <em>Settings</em> iOS → <em>Safari</em> (atau Chrome) → <em>Camera</em> → pilih <em>Allow</em>.</p>
        </div>
        <div class="instr-block">
        ...
        <div class="instr-block">
          ...
          <p>Browser dalam aplikasi sering memblokir kamera. Buka link survei di Chrome atau Safari langsung.</p>
        </div>
      </div>
    {/if}
    ...
    <p class="contact-hint">
      Tidak dapat mengaktifkan kamera? Hubungi pemilik survei untuk informasi lebih lanjut.
    </p>
  </div>
</div>
