...
<div class="gate">
  ...
  <div class="body">
    ...
    <button class="link-btn" type="button" onclick={() => (showInstructions = !showInstructions)}>
      {showInstructions ? 'Sembunyikan petunjuk' : 'Cara mengaktifkan lokasi'}
    ...
    {#if showInstructions}
      <div class="instructions">
        ...
        <div class="instr-block">
          ...
          <p>Tap menu titik tiga → <em>Settings</em> → <em>Site settings</em> → <em>Location</em> → cari {siteHost} → <em>Allow</em>.</p>
        </div>
      </div>
    {/if}
